...
public class AdicionarCiclistaComPaisInvalidoTeste : AdicionarCiclistaTesteBase
{
    public AdicionarCiclistaComPaisInvalidoTeste(ITestOutputHelper output)
        : base(output)
    {
    }

    [Fact(DisplayName = "CT15 - StatusCode")]
    public void VerificaSeAdicionarCiclistaEstrangeiroComPaisInvalidoRetornaStatusPretendido()
    {
    ...
    [Fact(DisplayName = "CT15 - Response")]
    public void VerificaSeAdicionarCiclistaEstrangeiroComPaisInvalidoRetornaResponsePretendido()
    {
        var ciclistaDto = new AdicionarCiclistaDto(
            CiclistaEstrangeiro(),
            Cartao());
