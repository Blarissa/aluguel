...
{
    internal class EquipamentoDoubleTrancaCadastradaLivreEBicicletaCadastradaEmUso : IEquipamentoService
    {
        public EquipamentoDoubleTrancaCadastradaLivreEBicicletaCadastradaEmUso()
        {
        }
