...
{
    internal class EquipamentoDoubleTrancaCadastradaOcupadaEBicicletaCadastradaEmUso : IEquipamentoService
    {
        public EquipamentoDoubleTrancaCadastradaOcupadaEBicicletaCadastradaEmUso()
        {
        }
