...
{
    internal class EquipamentoDoubleTrancaCadastradaLivreEBicicletaSemCadastro: IEquipamentoService
    {
        public EquipamentoDoubleTrancaCadastradaLivreEBicicletaSemCadastro()
        {
        }
